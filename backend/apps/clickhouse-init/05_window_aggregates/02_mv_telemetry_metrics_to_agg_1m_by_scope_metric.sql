-- =========================================================
-- FILE NAME: 02_mv_telemetry_metrics_to_agg_1m_by_scope_metric.sql
-- MUC DICH:
--   Materialize telemetry_metrics thanh bucket 1 phut voi
...
-- DAU RA CHINH:
--   - telemetry_db.mv_telemetry_metrics_to_agg_1m_by_scope_metric
-- GHI CHU:
--   - Refactor bo hardcode semantic_class, is_numeric_metric,
--     severity_code khoi MV goc.
--   - Policy tra cuu bang dict_metric_profile o query/insert time.
--   - Khong tinh freshness o day; bucket aggregate khong co current-live semantics.
-- =========================================================
