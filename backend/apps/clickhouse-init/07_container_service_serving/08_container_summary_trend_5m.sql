-- =========================================================
-- FILE NAME: 08_container_summary_trend_5m.sql
-- MUC DICH:
--   Tao view xu huong trung han 5 phut cho Container tu aggregate 5m.
...
--   07_container_service_serving / mid-term trend / container 5m trend
-- PHU THUOC:
...
DROP VIEW IF EXISTS telemetry_db.container_summary_trend_5m;

CREATE VIEW telemetry_db.container_summary_trend_5m AS
SELECT
    bucket_start,
    container_id,
