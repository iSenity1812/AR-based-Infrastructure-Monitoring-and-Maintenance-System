...
export class UseCaseHttpExceptionFilter implements ExceptionFilter {
  ...
  private normalizeException(exception: unknown): {
    ...
    if (exception instanceof UnauthorizedUseCaseError) {
      return {
    ...
    if (exception instanceof ForbiddenUseCaseError) {
      return {
        statusCode: exception.statusCode,
        errorCode: exception.errorCode,
        message: exception.message,
    ...
    if (exception instanceof ConflictUseCaseError) {
      return {
        statusCode: exception.statusCode,
        errorCode: exception.errorCode,
        message: exception.message,
    ...
    if (exception instanceof NotFoundUseCaseError) {
      return {
        statusCode: exception.statusCode,
        errorCode: exception.errorCode,
        message: exception.message,
