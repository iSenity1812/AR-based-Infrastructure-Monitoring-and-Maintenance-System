    ...
    <div className="fixed inset-0 z-40 flex justify-end pointer-events-none">
      <div className="glass light:bg-muted/90 light:border-2 light:border-l-primary/50 relative h-full w-full max-w-md overflow-y-auto border-l border-cyan/20 p-6 pointer-events-auto flex flex-col justify-between">
        <div className="space-y-6">
          ...
          <div className="panel light:bg-secondary p-3 space-y-3">
            ...
            <div className="flex items-center justify-between text-[10px] text-muted-foreground/85 light:font-semibold light:text-muted-foreground">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              {stats.rooms.map((roomCode) => (
                <div
                  key={roomCode}
                  className="flex items-center justify-between panel light:bg-primary p-3 text-xs hover:border-[#00D1FF]/40 hover:bg-cyan hover:light:bg-primary/80 transition duration-200"
                >
                  <span className="font-mono text-foreground/90 light:text-background light:font-bold">
                    {roomCode}
                  </span>
                  <span className=" text-[11px] text-muted-foreground/70 light:text-background light:font-bold">
                    {
                      siteTopology.filter(
