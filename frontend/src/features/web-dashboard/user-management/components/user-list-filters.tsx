  ...
  return (
    <div className="panel space-y-4 p-4">
      <div className="flex flex-wrap items-center gap-3">
        <label className="flex h-9 min-w-65 flex-1 items-center gap-2 rounded-md border border-cyan/15 bg-surface-1 px-3">
        ...
        <div className="relative">
          ...
          >
            <span className="label-mono text-[10px]">Role</span>
          ...
          {openMenu === "role" ? (
            <div className="absolute left-0 top-full z-20 mt-2 w-60 overflow-hidden rounded-lg border border-cyan/30 bg-surface-2 shadow-[0_18px_40px_rgba(0,0,0,0.35)]">
              <button
                type="button"
                onClick={() => onSelectRole("ALL")}
                className="flex w-full items-center justify-between border-b border-border/60 px-3 py-2 text-left text-muted-foreground transition hover:bg-white/5 hover:text-foreground"
              >
        ...
        <div className="relative">
          ...
          {openMenu === "status" ? (
            <div className="absolute left-0 top-full z-20 mt-2 w-35 overflow-hidden rounded-lg border border-cyan/30 bg-surface-2 shadow-[0_18px_40px_rgba(0,0,0,0.35)]">
              <button
                type="button"
      ...
      <div className="flex flex-wrap items-center gap-2">
        {selectedRole !== "ALL" ? (
          ...
          >
            <span className="label-mono">Role: {selectedRoleChipLabel}</span>
