...
const (
	TelemetryIngestService_IngestBatch_FullMethodName = "/api.telemetry.v1.TelemetryIngestService/IngestBatch"
)
...
func (c *telemetryIngestServiceClient) IngestBatch(ctx context.Context, in *IngestBatchRequest, opts ...grpc.CallOption) (*IngestBatchResponse, error) {
...
func (UnimplementedTelemetryIngestServiceServer) IngestBatch(context.Context, *IngestBatchRequest) (*IngestBatchResponse, error) {
...
var TelemetryIngestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.telemetry.v1.TelemetryIngestService",
